          ...
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <h1 className="text-2xl font-bold text-indigo-900">RMSS</h1>
                <p className="text-sm text-gray-600">Raymond's Math & Science Studio</p>
              </div>
            </div>
            <nav className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-4">
                <a href="#" className="text-indigo-900 hover:text-indigo-700 px-3 py-2 text-sm font-medium">Home</a>
                <a href="#" className="text-gray-600 hover:text-indigo-700 px-3 py-2 text-sm font-medium">About Us</a>
                <a href="#" className="text-gray-600 hover:text-indigo-700 px-3 py-2 text-sm font-medium">Courses</a>
                <a href="#" className="text-gray-600 hover:text-indigo-700 px-3 py-2 text-sm font-medium">Locations</a>
                <a href="#" className="text-gray-600 hover:text-indigo-700 px-3 py-2 text-sm font-medium">Contact</a>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button className="border border-indigo-600 text-indigo-600 px-8 py-3 rounded-lg text-lg font-semibold hover:bg-indigo-50 transition duration-300">
                Learn More
              </button>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50">
              ...
              <h3 className="text-xl font-semibold text-indigo-900 mb-2">Expert Teachers</h3>
            ...
            <div className="text-center p-6 rounded-lg bg-gradient-to-br from-green-50 to-emerald-50">
              ...
              <h3 className="text-xl font-semibold text-emerald-900 mb-2">Small Class Sizes</h3>
            ...
            <div className="text-center p-6 rounded-lg bg-gradient-to-br from-purple-50 to-violet-50">
              ...
              <h3 className="text-xl font-semibold text-violet-900 mb-2">Proven Results</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-5 gap-6">
            {['Jurong', 'Bishan', 'Punggol', 'Kovan', 'Marine Parade'].map((location) => (
              <div key={location} className="text-center p-4 bg-white rounded-lg shadow-md hover:shadow-lg transition duration-300">
                <h3 className="text-lg font-semibold text-indigo-900 mb-2">{location}</h3>
      ...
      <section className="py-16 bg-indigo-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8">
            Contact us today for enrollment or inquiries
          </p>
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg">6222 8222</span>
            </div>
            <div className="flex items-center gap-2">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
